...
variable "main_project"         { default = "color" }   # Set this VARIABLE - this will form  the name of RESOURCES
...
variable "container_image"      { default = "linuxramu/color:2.5" }

variable "dns_name_label"       { default = "color123" }  # Set this VARIABLE - this will be URL of application, should be unique
